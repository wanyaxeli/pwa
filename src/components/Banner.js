...
export default function Banner() {
  return (
    <div className='container-fluid position-relative bg-success w-100 px-0'style={{height:500,}}  >
        ...
        <div style={{backgroundColor:'#429fef'}} className='position-absolute top-0 opacity-75  w-100 h-100'>
          ...
          <Header/>
           <div style={{color:'#fff'}} className='h-75 m-auto  w-75 d-flex flex-column justify-content-center align-items-center '>
